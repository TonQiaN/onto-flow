...
/** 排序键、默认排序与页长在 @/lib/list-query，与服务端的 parseListQuery 同一份；这里只加标签。 */
export { DEFAULT_PAGE_SIZE, DEFAULT_SORT, isSortKey, type SortKey };
...
/** 下拉里的排序项：键由 SORT_KEYS 给出，顺序与它一致，标签在上面那张表里。 */
export const SORT_OPTIONS: ReadonlyArray<{ value: SortKey; label: string }> = SORT_KEYS.map(
